window.question_set = {
	...
	formulas: [
		{ name : 'EMO', 
			...
			tm: [
					50,50,51,55,59, 62,65,67,69,70, //1-10
					73,77,80,83,87, 90,93,97,100 //11-19
				],
		},
		{ name : 'ANX', 
			q: [10,33,37,43,47,68,87,90],
			tm: [	
					50,50,51,52,56, 59,63,66,69,70,
					74,79,83,87,91, 96,100
				]
		},
		{ name : 'SOM', 
			q: [1,7,12,19,24,39,45,52,78,86,93],
			tm: [
					50,50,53,58,62, 65,68,70,72,74,
